    ...
    public class Calendar : ICalendar
    {
        ...
        private void SetBSCalendar()
        {
            BSCalendar = new Dictionary<int, int[]>
            {
                ...
                { 91, new int[] { 2090, 31, 31, 32, 31, 31, 31, 30, 30, 29, 30, 30, 30 } },
                { 92, new int[] { 2090, 30, 31, 32, 32, 31, 30, 30, 30, 29, 30, 30, 30 } },
                { 93, new int[] { 2090, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30 } },
                { 94, new int[] { 2090, 31, 31, 32, 31, 31, 30, 30, 30, 29, 30, 30, 30 } },
                { 95, new int[] { 2090, 31, 31, 32, 31, 31, 31, 30, 29, 30, 30, 30, 30 } },
                { 96, new int[] { 2090, 30, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30 } },
                { 97, new int[] { 2090, 31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30 } },
                { 98, new int[] { 2090, 31, 31, 32, 31, 31, 31, 29, 30, 29, 30, 29, 31 } },
                { 99, new int[] { 2090, 31, 31, 32, 31, 31, 31, 30, 29, 29, 30, 30, 30 } }
            };
        }
    }
}
